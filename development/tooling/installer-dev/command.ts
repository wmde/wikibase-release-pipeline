	...
	installerDev
		...
		.addHelpText(
			...
			[
				...
				'',
				'Mock behavior:',
				'  Builds only wbs-tools, makes installer steps directly navigable, and retains',
				'  normal form validation. Starting installation streams an accelerated simulated',
				'  image-pull and service-startup log through completion. It does not write .env,',
				'  signal the host launcher, or start Suite services.',
				'',
				'Examples:',
				'  wbs-dev installer-dev web',
				'  wbs-dev installer-dev web --mock'
