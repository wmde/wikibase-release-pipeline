...
A key part of release pipeline is to produce a bundled Wikibase Docker Image prepared with the extensions and components known as Wikibase Suite. This bundle image will consist of the build artifacts and as described in [ADR0001](0001-docker-image-repository.md) these images should be published to dockerhub.
