...
#### docker-compose.yml
To further customize your instance, consider adjusting `docker-compose.yml`. In order to ease updating to newer versions of the WBS Deployment Kit, consider putting your customization into a new file called `docker-compose.override.yml` and from now on, restart your instance with
