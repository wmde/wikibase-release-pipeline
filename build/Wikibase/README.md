...
This image contains the Wikibase extension running on top of MediaWiki. Besides Wikibase itself, several other extensions are bundled. The MediaWiki application runs on top of PHP on an Apache web server in a Debian base image.
...
| [SyntaxHighlight](https://www.mediawiki.org/wiki/Extension:SyntaxHighlight)                                                                                                                                                 | Allows source code to be syntax-highlighted on the wiki pages.                                                                     |
