...
UPDATE_SUBMODULE=1 bash "$ROOT"/build/clone_repo.sh "$QUERYSERVICE_UI_COMMIT_HASH" "$ROOT/git_cache/services/wikidata-query-gui.git" wdqs_ui "$WDQS_UI_GIT_DIR" master
