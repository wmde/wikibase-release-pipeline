...
REQUIRED_VARIABLES=(QUICKSTATEMENTS_PUBLIC_URL WB_PUBLIC_SCHEME_HOST_AND_PORT WIKIBASE_PUBLIC_URL WB_PROPERTY_NAMESPACE WB_PROPERTY_PREFIX WB_ITEM_NAMESPACE WB_ITEM_PREFIX)
