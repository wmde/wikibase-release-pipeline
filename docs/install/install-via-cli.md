...
| `WIKIMEDIA_OAUTH_CONSUMER_TOKEN` (optional) | None | Wikimedia OAuth consumer token. See [Enabling Login with Wikimedia](../configure/enable-login-with-wikimedia.md). |
