...
The following paths can be used to extend this image. See the [Dockerfile](https://github.com/wmde/wikibase-suite/blob/main/development/images/wikibase/Dockerfile) for its source.
