...
Run these commands from the Wikibase Suite directory. They create a `backup` directory beside the repository, shut down the instance, and dump the contents of all Docker volumes into `.tar.gz` files there.
