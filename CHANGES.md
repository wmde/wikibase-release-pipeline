...
|---------------|----------------------|----------------|------------| --------------|
| wmde.14 ([spec](https://github.com/wmde/wikibase-release-pipeline/blob/wmde.14/variables.env)) | MediaWiki (1.40.1, PHP 8.1.25), WDQS (0.3.135)    | 15 November 2023 | [6874036679](https://github.com/wmde/wikibase-release-pipeline/actions/runs/6874036679) | [T340939](https://phabricator.wikimedia.org/T340939) |
