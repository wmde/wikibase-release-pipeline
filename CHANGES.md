...
## Work In Progress - April: 2023: 1.39.3 Security release
...
|---------------|-------------------|----------------|------------| --------------|
| wmde.13 ([spec](),[metadata]()) | MediaWiki (1.39.3, PHP 8.0, PHP 8.1, PHP 8.2) | April 2023 | ??? | [T332786](https://phabricator.wikimedia.org/T332786) |
