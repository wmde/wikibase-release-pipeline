...
### Wikibase Release Pipeline 2.0.0

#### WBS Images

| Image               | WBS Version | Upstream Version     | Base Image                    | Distribution    |
| ------------------- | ----------- | -------------------- | ----------------------------- | --------------- |
| WBS Wikibase        | 2.0.0       | MediaWiki 1.41.2     | PHP 8.3.8 apache              | Debian Bookworm |
...
https://phabricator.wikimedia.org/T368254
...
## April 2024: Major releases for 1.41.0
