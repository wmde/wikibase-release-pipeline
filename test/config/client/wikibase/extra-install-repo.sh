...
echo "INSERT INTO \`interwiki\` (\`iw_prefix\`, \`iw_url\`, \`iw_api\`, \`iw_wikiid\`, \`iw_local\`, \`iw_trans\`) VALUES ('client_wiki', 'http://wikibase-client.svc/wiki/\$1', 'http://wikibase-client.svc/w/api.php', '', '1', '0')" | \
php /var/www/html/maintenance/patchSql.php --wiki=my_wiki /dev/stdin
